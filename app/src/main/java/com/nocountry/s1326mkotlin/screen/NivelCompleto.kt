...
@Composable
fun NivelCompleto(navController: NavController) {

    var posiciones by remember { mutableStateOf("") }
    ...
    horizontalAlignment = Alignment.CenterHorizontally
        ...
        Box(
            ...
            Image(
                painter = painterResource(id = R.drawable.completo),
        ...
        Button(
            ...
            modifier = Modifier
                ...
                .clickable(onClick = { navController.navigate("logros") })
        ) {
            Text(
                text = "Ver Posiciones",
                fontSize = 26.sp,
        ...
        Button(
            onClick = { navController.navigate("temas") }, // Redirige a la pantalla de temas
            colors = ButtonDefaults.buttonColors(
            ...
            modifier = Modifier
                ...
                .clickable(onClick = { navController.navigate("temas") })
        ) {
            Text(
