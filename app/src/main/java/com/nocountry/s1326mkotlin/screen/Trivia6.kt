...
@Composable
fun Trivia6(navController: NavController) {
    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                // Pregunta
                Text(
                    text = "¿Qué documento estableció los derechos y deberes entre los señores y los vasallos?",
                    fontSize = 16.sp,
                    fontFamily = FontFamily(Font(R.font.poppins_regular)),
                    color = Color.Black,
                ...
                val botonEnviarBackgroundColor = if (respuestaSeleccionada == "Feudo") Color(0xFFB1FCDC) else Color(0xFFFFFDFE)

                TextButton(
                    onClick = {
                        if (respuestaSeleccionada == "Feudo") {
                            navController.navigate("completo")
                        } else {
                            respuestaSeleccionada == "Carta" || respuestaSeleccionada == "Contrato" || respuestaSeleccionada == "Ley"
...
@Composable
fun RespuestaItemT6(text: String, onClick: () -> Unit, seleccionada: Boolean) {
