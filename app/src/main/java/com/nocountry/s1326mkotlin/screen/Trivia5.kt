...
@Composable
fun Trivia5(navController: NavController) {
    ...
    Column(
        ...
        Box(
            ...
            Image(
                painter = painterResource(id = R.drawable.barra5),
        ...
        Card(
            ...
            Column(
                ...
                // Pregunta
                Text(
                    text = "¿Cuál era la principal actividad económica en las ciudades medievales?",
                    fontSize = 16.sp,
                    fontFamily = FontFamily(Font(R.font.poppins_regular)),
                    color = Color.Black,
                ...
                val botonEnviarBackgroundColor = if (respuestaSeleccionada == "Comercio") Color(0xFFB1FCDC) else Color(0xFFFFFDFE)

                TextButton(
                    onClick = {
                        if (respuestaSeleccionada == "Comercio") {
                            navController.navigate("completo")
                        } else {
                            respuestaSeleccionada == "Agricultura" || respuestaSeleccionada == "Artesania" || respuestaSeleccionada == "Guerras"
...
@Composable
fun RespuestaItemT5(text: String, onClick: () -> Unit, seleccionada: Boolean) {
